...
const HTTP_PROTOCOL = process.env.HTTP_PROTOCOL || 'https';
const API_URL = process.env.API_URL = 'staging.zoomscript.nl';
    ...
    return webpackMerge(commonConfig({
        ...
        plugins: [
            ...
            new DefinePlugin({
                ...
                'HMR': METADATA.HMR,
                'AOT': METADATA.AOT,
                'HTTP_PROTOCOL': JSON.stringify(METADATA.HTTP_PROTOCOL),
                'API_URL': JSON.stringify(METADATA.API_URL),
                'process.env.ENV': JSON.stringify(METADATA.ENV),
                'process.env.NODE_ENV': JSON.stringify(METADATA.ENV),
                'process.env.HMR': METADATA.HMR,
                'process.env.API_URL': JSON.stringify(METADATA.API_URL),
                'process.env.HTTP_PROTOCOL': JSON.stringify(METADATA.HTTP_PROTOCOL),
            }),
