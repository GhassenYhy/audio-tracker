...
import { TranscriptUpgradeModalComponent } from '../../../shared/components/transcript-upgrade-modal/transcript-upgrade-modal.component';
...
export class TranscriptComponent implements OnInit, OnDestroy {
        ...
        this.sub = this.route.params.subscribe(params => {
            ...
            this.data$.subscribe(
                (data) => {
                    ...
                    this.revertableResults = JSON.parse(JSON.stringify(this.results));
    ...
    revertToOriginal() {
        ...
        this.transcriptsService.submitResults(this.id, this.revertableResults)
            .subscribe(
                data => {
                    this.results = JSON.parse(JSON.stringify(this.revertableResults));
                    this.toastr.success("Transcript has been reverted");
                    this.revertable = false;
                },
    ...
    downloadSBV() {
        ...
        this.transcriptsService.getSBV(this.id).subscribe(
            (data) => {
                ...
                if (data) {
                    ...
                    let blob = new Blob([data], { type: "application/sbv" });
                    let fileName: string = this.id + ".sbv";
    ...
    downloadDOC() {
        ...
        this.transcriptsService.getDOC(this.id, this.speakersCheck, this.timestampsCheck).subscribe(
            (data) => {
                ...
                if (data) {
                    ...
                    let blob = new Blob([data], { type: "application/doc" });
                    let fileName: string = this.id + ".doc";
    ...
    openUpgradeModalVerticallyCentered(id, content){
        this.modalService.open(content,{size:'lg'});
        this.id = id;
    }

    getPaymentLink = () => {
        this.orderService.upgradeToPerfect(this.id).subscribe(
            (data) => {
                console.log(data);
    ...
    public openShortcutsModal() {
        const modalRef = this.modalService.open(ShortcutsModalComponent, { size: 'lg' });
        modalRef.componentInstance.name = 'Shortcuts';
    }
    //
    // public openTranscriptUpgradesModal() {
    //     const modalRef = this.modalService.open(TranscriptUpgradeModalComponent, { size: 'lg' });
    //     modalRef.componentInstance.name = 'TranscriptUpgra';
    // }
